    ...
    try {
        ...
        const sql = `
            SELECT
                ...
                (SELECT COUNT(*) FROM patients WHERE DATE(registered_date AT TIME ZONE 'UTC' AT TIME ZONE 'Africa/Addis_Ababa') = DATE(CURRENT_TIMESTAMP AT TIME ZONE 'UTC' AT TIME ZONE 'Africa/Addis_Ababa')) as new_today,
